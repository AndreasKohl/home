        ...
        <div class="col-xs-12 col-sm-12 col-md-12 lights">
            ...
            <form method="post" class="form-vertical row-border">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <input type="text" name="weather_api" value="<?php echo $settings['weather_api']; ?>"
                               class="form-control"><br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <input type="text" name="oc_user" id="oc_user" value="<?php echo $settings['oc_user']; ?>"
                               class="form-control"><br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <input type="text" name="oc_pass" id="oc_pass" value="<?php echo $settings['oc_pass']; ?>"
                               class="form-control"><br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-12 col-md-12 control-label"><?php echo SET_sarkasmus; ?></label>

                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <input type="hidden" id="a_sarkasmus_activ" value="<?php echo $settings['sarkasmus']; ?>">
                        <select name="sarkasmus" id="sarkasmus_activ" class="form-control">
                            <option value="true">Aktiv</option>
                            <option value="false" <?php echo ($settings['sarkasmus'] == 'false' ? 'selected' : '' ); ?>>Inaktiv</option>
                        </select>
                        <br>
                    </div>
                </div>
